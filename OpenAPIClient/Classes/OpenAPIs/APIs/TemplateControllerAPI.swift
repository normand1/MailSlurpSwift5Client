...
open class TemplateControllerAPI {
     ...
     */
    open class func createTemplate(createTemplateOptions: CreateTemplateOptions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: TemplateDto?,_ error: Error?) -> Void)) {
    ...
    open class func createTemplateWithRequestBuilder(createTemplateOptions: CreateTemplateOptions) -> RequestBuilder<TemplateDto> {
        ...
        let requestBuilder: RequestBuilder<TemplateDto>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteTemplate(templateId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllTemplates(page: Int? = nil, size: Int? = nil, sort: Sort_getAllTemplates? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PageTemplateProjection?,_ error: Error?) -> Void)) {
    ...
    open class func getAllTemplatesWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllTemplates? = nil) -> RequestBuilder<PageTemplateProjection> {
        ...
        let requestBuilder: RequestBuilder<PageTemplateProjection>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTemplate(templateId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: TemplateDto?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTemplates(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [TemplateProjection]?,_ error: Error?) -> Void)) {
    ...
    open class func getTemplatesWithRequestBuilder() -> RequestBuilder<[TemplateProjection]> {
        ...
        let requestBuilder: RequestBuilder<[TemplateProjection]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
