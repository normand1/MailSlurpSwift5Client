...
open class AliasControllerAPI {
     ...
     */
    open class func createAlias(createOwnedAliasOptions: CreateOwnedAliasOptions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createAnonymousAlias(createAnonymousAliasOptions: CreateAnonymousAliasOptions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Alias?,_ error: Error?) -> Void)) {
    ...
    open class func createAnonymousAliasWithRequestBuilder(createAnonymousAliasOptions: CreateAnonymousAliasOptions) -> RequestBuilder<Alias> {
        ...
        let requestBuilder: RequestBuilder<Alias>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteAlias(aliasId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAlias(aliasId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Alias?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAliases(page: Int? = nil, size: Int? = nil, sort: Sort_getAliases? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PageAlias?,_ error: Error?) -> Void)) {
    ...
    open class func getAliasesWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAliases? = nil) -> RequestBuilder<PageAlias> {
        ...
        let requestBuilder: RequestBuilder<PageAlias>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateAlias(aliasId: UUID, createOwnedAliasOptions: CreateOwnedAliasOptions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
