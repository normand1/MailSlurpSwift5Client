...
open class WebhookControllerAPI {
     ...
     */
    open class func createWebhook(inboxId: UUID, webhookOptions: CreateWebhookOptions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: WebhookDto?,_ error: Error?) -> Void)) {
    ...
    open class func createWebhookWithRequestBuilder(inboxId: UUID, webhookOptions: CreateWebhookOptions) -> RequestBuilder<WebhookDto> {
        ...
        let requestBuilder: RequestBuilder<WebhookDto>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteWebhook(inboxId: UUID, webhookId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllWebhooks(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhooks? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PageWebhookProjection?,_ error: Error?) -> Void)) {
    ...
    open class func getAllWebhooksWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhooks? = nil) -> RequestBuilder<PageWebhookProjection> {
        ...
        let requestBuilder: RequestBuilder<PageWebhookProjection>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getWebhook(webhookId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: WebhookDto?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getWebhooks(inboxId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WebhookDto]?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sendTestData(webhookId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: WebhookTestResult?,_ error: Error?) -> Void)) {
    ...
    open class func sendTestDataWithRequestBuilder(webhookId: UUID) -> RequestBuilder<WebhookTestResult> {
        ...
        let requestBuilder: RequestBuilder<WebhookTestResult>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
