...
open class ContactControllerAPI {
     ...
     */
    open class func createContact(createContactOptions: CreateContactOptions, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ContactDto?,_ error: Error?) -> Void)) {
    ...
    open class func createContactWithRequestBuilder(createContactOptions: CreateContactOptions) -> RequestBuilder<ContactDto> {
        ...
        let requestBuilder: RequestBuilder<ContactDto>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteContact(contactId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllContacts(page: Int? = nil, size: Int? = nil, sort: Sort_getAllContacts? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PageContactProjection?,_ error: Error?) -> Void)) {
    ...
    open class func getAllContactsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllContacts? = nil) -> RequestBuilder<PageContactProjection> {
        ...
        let requestBuilder: RequestBuilder<PageContactProjection>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getContact(contactId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ContactDto?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getContacts(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [ContactProjection]?,_ error: Error?) -> Void)) {
    ...
    open class func getContactsWithRequestBuilder() -> RequestBuilder<[ContactProjection]> {
        ...
        let requestBuilder: RequestBuilder<[ContactProjection]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
