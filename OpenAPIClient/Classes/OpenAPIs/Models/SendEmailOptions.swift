...
public struct SendEmailOptions: Codable {
    ...
    public init(attachments: [String]? = nil, bcc: [String]? = nil, body: String? = nil, cc: [String]? = nil, charset: String? = nil, from: String? = nil, isHTML: Bool? = nil, replyTo: String? = nil, sendStrategy: SendStrategy? = nil, subject: String? = nil, template: UUID? = nil, templateVariables: Any? = nil, to: [String]? = nil, toContacts: [UUID]? = nil, toGroup: UUID? = nil) {
